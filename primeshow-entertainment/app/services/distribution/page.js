...
export const metadata=createMetadata({title:"Film Distribution Company in India",description:"PrimeShow Entertainment provides regional, Pan-India, overseas and multilingual film distribution, connecting Indian cinema with theatres and audiences worldwide.",path:"/services/distribution",image:"/images/distribution-hero.webp"});
